...
|---|---|---|---|---|---|
| [Pronunciation Assessment](https://aws.amazon.com/marketplace/pp/prodview-uzfcfzqcmds7i) | 1.0.2 | SageMaker model package | French, Arabic | 16 | [`pronunciation-sagemaker/`](pronunciation-sagemaker/) |
